    ...
    private void initializeGridView() {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                Toast.makeText(VidsActivity.this, "" + position +" " + selectedSubCategory, Toast.LENGTH_SHORT).show();
                ...
                if (selectedSubCategory != null) {
                    ...
                    if(VidsApplUtil.TYPE_VIDEO.equals(videoType)){
                        // start the video list activity here
//                        getSupportFragmentManager().beginTransaction()
//                                .replace(R.id.fragment_frame, mVideoFragment, mVideoFragment.getClass().getSimpleName()).commit();
//                        if (listener != null) {
...
//                        }
                        ...
                        // start the plalist activity here
//                        getSupportFragmentManager().beginTransaction()
